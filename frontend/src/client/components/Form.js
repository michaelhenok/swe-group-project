    ...
    return (
        <FormContainer>
            ...
            <div style={{position:'absolute', top: '111%', left:'5%'}}>
                <h2 className="text-uppercase text-center" style={{fontSize: '75px', color:'blue'}}>Get 15% Discount !
                   <p><span style={{color: 'blue', fontStyle: 'italic', fontSize: '65px'}}>For Your first Rent with us</span></p> </h2>
            </div>
        </FormContainer>
    );
};
